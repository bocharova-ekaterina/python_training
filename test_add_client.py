...
class TestAddGroup(unittest.TestCase):
    ...
    def test_add_group(self):
        ...
        driver.find_element_by_name("mobile").send_keys("987456321")
        driver.find_element_by_name("work").click()
        driver.find_element_by_name("work").clear()
        driver.find_element_by_name("work").send_keys("635241")
        driver.find_element_by_name("email").click()
        driver.find_element_by_name("email").clear()
        driver.find_element_by_name("email").send_keys("tester@mail.ru")
        driver.find_element_by_name("email2").click()
        driver.find_element_by_name("email2").clear()
        driver.find_element_by_name("email2").send_keys("tester11@mail.ru")
